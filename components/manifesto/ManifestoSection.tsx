    ...
    >
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-16 py-20 md:py-32">
        ...
        <p
          ...
          className="font-[SpaceGrotesk] leading-loose mb-24 max-w-2xl"
        ...
        <div
          ref={footerRef}
          className="mt-28 pt-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 opacity-0"
